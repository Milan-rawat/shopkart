                    ...
                    <div className="bottomNav" style={{backgroundColor: this.state.scrollUp? 'rgba(100, 200, 255, 0.3)' : ''}}>
                        ...
                        <div className="searchBarBox" style={{width: this.state.scrollUp? '75%' : '95%'}}>
                            ...
                            <div className="searchIcon">
                                {
                                    this.state.searched ? <button type="submit" onClick={this.searchForProduct}>
                            ...
                            this.state.product.slice(0,this.state.showOnly).map((item, i) =>
                                <div className="searchResultProductCard" key={i}>
                                    ...
                                    <div className="resultDescription">
                                        ...
                                        <span style={{color: "grey"}}>{item.productDescription}</span>
                                    </div>
                                </div>
                            )
                        }
                    </div>
                    <div style={{display: this.state.showOnlyBtn?'flex':'none'}} className="moreShowBtns">
                        <button onClick={()=> this.setState({showOnly: this.state.showOnly-10})} style={{display: this.state.showOnly<=10?'none':'block'}}>show less</button>
                        <button onClick={()=> this.setState({showOnly: this.state.showOnly+10})} style={{display: (this.state.showOnly>=this.state.product.length)?'none':'block'}}>show more</button>
                    </div>
                </div>
            </>
        )
