            ...
            <>
                ...
                <div className="pg">
                    <div className="page">
                        ...
                        <div className="form">
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <input value={this.state.email} onChange={this.liveSearching} type="email" /><br />
                                </div>
                                <div>
                                    <label>Password</label><br />
                                    <input value={this.state.password} onChange={e => this.setState({password: e.target.value})} type="password" /><br/>
                                </div>
                                <div>
                        ...
                        <div className="abc"><span>New to ShopKart?</span>
                            <Link to="/user/signup"><button>Create your Account</button></Link>
                            <Link to="/"><button>Cancel Signin</button></Link>
                        </div>
                    </div>
                </div>
            </>
